...
HudAssets = {'healthBarBG','healthBar','scoreTxt','iconP1','iconP2','timeBar','timeBarBG','timeTxt','hpBar'}
Index = 1
		...
		if Speed and Distance > 0 then
			...
			for Tweens = 0,7 do 
				...
				for Alphas = 1,8 do
					...
					doTweenAlpha('fuckinghealthbar', 'healthBar', 0, Speed - 0.1, 'linear');
					doTweenAlpha('fuckingscoreTxt', 'scoreTxt', 0, Speed - 0.1, 'linear');					
					Index = Index + 1
		...
		if Distance <= 0 then
			...
			for Tweens = 0,7 do 
				...
				for Alphas = 1,8 do
					...
					doTweenAlpha('hihealthbar', 'healthBar', 1, Speed - 0.1, 'linear');
					doTweenAlpha('hiscoreTxt', 'scoreTxt', 1, Speed - 0.1, 'linear');	
					Index = Index + 1
